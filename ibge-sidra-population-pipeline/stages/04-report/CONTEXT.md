...
2. Read the DQ report from Silver (`ibge-sidra-population-dq-report.md`) to extract failure reasons.
...
5. Author the report in `output/ibge-sidra-population-report.md` following `references/report-template.md`. Sections:
...
|----------|----------|--------|
| Final report | `output/ibge-sidra-population-report.md` | Markdown document with executive summary, row counts, DQ findings, Gold aggregates, recommendations |
