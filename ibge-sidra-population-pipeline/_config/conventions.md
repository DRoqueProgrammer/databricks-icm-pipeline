...
Examples:
- `ibge.ibge_sidra_population_bronze.ibge_sidra_population_raw`
- `ibge.ibge_sidra_population_silver.ibge_sidra_population_clean`
- `ibge.ibge_sidra_population_gold.ibge_sidra_population_by_state_year`
...
- Commit message format: `[ibge-sidra-population] bronze+silver+gold+report`